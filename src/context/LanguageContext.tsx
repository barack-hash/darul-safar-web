...
const translations: Record<Lang, Translations> = {
  en: {
    nav: { home: "Home", pilgrimage: "Pilgrimage", visas: "Visas", tools: "Tools" },
    hero: { 
  ...
  ar: {
    nav: { home: "الرئيسية", pilgrimage: "الحج والعمرة", visas: "التأشيرات", tools: "الأدوات" },
    hero: { 
  ...
  am: {
    nav: { home: "ዋና ገፅ", pilgrimage: "ሐጅ እና ዑምራ", visas: "ቪዛ", tools: "መሳሪያዎች" },
    hero: { 
  ...
  om: {
    nav: { home: "Fuula Duraa", pilgrimage: "Hajjii fi Umrah", visas: "Viizaa", tools: "Meeshaalee" },
    hero: { 
